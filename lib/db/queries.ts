...
export async function updateUser(
  ...
  try {
    const row = await prisma.user.update({ where: { id }, data: user });
    return mapUser(row);
  } catch (e) {
...
export async function getApplicationById(
  ...
  try {
    return (await prisma.application.findUnique({ where: { id } })) ?? undefined;
  } catch (e) {
...
export async function createApplication(
  ...
  try {
    return await prisma.application.create({ data: application });
  } catch (e) {
...
export async function createExperience(
  ...
  try {
    const row = await prisma.experience.create({ data: experience });
